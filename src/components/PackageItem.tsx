  ...
  return (
    <div className="w-full border-2 border-solid border-zinc-800 my-1 shadow-sm px-3 py-1 rounded-md">
      <div className="flex items-center justify-between">
        <a href={`https://www.npmjs.com/package/${props.package.packageName}`} 
          rel="noreferrer" target="_blank" className="text-lg text-zinc-200 
        ...
        {props.package.removeable && <button className={`transition-all duration-200 

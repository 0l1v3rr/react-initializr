        ...
        >
          ...
          >
            <label className="flex relative items-center gap-3 cursor-pointer">
              ...
              <span
                className="w-4 h-4 border border-zinc-800 rounded-sm relative
                  ...
                  before:absolute before:content[''] before:w-[1px]
                  before:h-[85%] before:rotate-45 before:top-1/2 before:left-1/2
                  before:-translate-x-1/2 before:-translate-y-1/2 before:opacity-0
                  after:absolute after:content[''] bg-react-before-after after:w-[1px]
                  after:h-[85%] after:rotate-[135deg] after:top-1/2 after:left-1/2
